...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ScopedModel.of<CartBookModel>(context, rebuildOnChange: true).cart.length == 0 ? Center(child: Text("No Books in Cart"),)
            : Container(
            padding: EdgeInsets.all(8.0),
            child: Column(children: <Widget>[
              Expanded(
                child: ListView.builder(
                  itemCount: ScopedModel.of<CartBookModel>(context,
              ...
              Container(
                  padding: EdgeInsets.all(8.0),
                  child: Text(
                    "Total: \฿ " + ScopedModel.of<CartBookModel>(context, rebuildOnChange: true).totalCartValue.toString() + " Bath",
